...
export class MailerService {
  ...
  getMailOptions(
    ...
    const mailOptions = {
      from: `"AI Website Builders" <${process.env.APP_EMAIL}>`, // Pretty sender name
      to: recepient,
      subject: subject,
      html: `
        <!DOCTYPE html>
              ...
              ${
                doctor
                  ...
                  : appointment
                    ...
                    <p style="margin-top: 20px;">Thank you for choosing AI Website Builders.</p>
                  `
              }
            </div>
            <div class="email-footer">
              &copy; ${new Date().getFullYear()} AI Website Builders. All rights reserved.
            </div>
          </div>
        </body>
        </html>
